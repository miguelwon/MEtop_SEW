...
#include"num_out.h"
#include"num_in.h"
extern FNN F1007_out;
static void C1007(REAL * C)
{
REAL* V=va_out;
REAL S[9];                                                                  
...
S[1]=V[12]*V[12];
S[2]=V[9]*V[9]*V[9]*V[9];
C[66]=+S[2]*(S[1]*(V[32]*(10*V[33]+5*V[32])+5*S[0]));
C[65]=+S[2]*(V[32]*(10*V[32]-20*V[33])+10*S[0]);
C[64]=+S[2]*(S[1]*(V[32]*(8*V[33]+4*V[32])+4*S[0]));
C[63]=+S[2]*(V[32]*(18*V[32]-36*V[33])+18*S[0]);
C[62]=+S[2]*(S[1]*(V[32]*(14*V[33]+7*V[32])+7*S[0]));
C[61]=+S[2]*(V[32]*(2*V[32]-4*V[33])+2*S[0]);
C[60]=+S[2]*(S[1]*(V[32]*(16*V[33]+8*V[32])+8*S[0]));
C[59]=+S[2]*(V[32]*(4*V[32]-8*V[33])+4*S[0]);
S[3]=V[9]*V[9];
C[58]=+S[3]*(S[1]*(V[32]*(56*V[33]+28*V[32])+28*S[0]));
C[57]=+S[1]*(V[32]*(56*V[33]+28*V[32])+28*S[0]);
C[56]=+V[32]*(8*V[32]-16*V[33])+8*S[0];
C[55]=+S[3]*(S[1]*(V[32]*(40*V[33]+20*V[32])+20*S[0]));
C[54]=+S[3]*(V[32]*(40*V[32]-80*V[33])+40*S[0]);
C[53]=+S[1]*(V[32]*(40*V[33]+20*V[32])+20*S[0]);
C[52]=+V[32]*(40*V[32]-80*V[33])+40*S[0];
C[51]=+S[3]*(V[32]*(72*V[32]-144*V[33])+72*S[0]);
C[50]=+S[3]*(S[1]*(V[32]*(64*V[33]+32*V[32])+32*S[0]));
C[49]=+S[1]*(V[32]*(32*V[33]+16*V[32])+16*S[0]);
C[48]=+V[32]*(72*V[32]-144*V[33])+72*S[0];
C[47]=+S[1]*(V[32]*(64*V[33]+32*V[32])+32*S[0]);
C[46]=+V[32]*(16*V[32]-32*V[33])+16*S[0];
C[45]=+S[3]*(S[1]*(V[32]*(24*V[33]+12*V[32])+12*S[0]));
C[44]=+S[3]*(V[32]*(24*V[32]-48*V[33])+24*S[0]);
C[43]=+S[3]*(V[32]*(120*V[32]-240*V[33])+120*S[0]);
C[42]=+S[3]*(V[32]*(192*V[32]-384*V[33])+192*S[0]);
C[41]=+S[3]*(V[32]*(160*V[32]-320*V[33])+160*S[0]);
C[40]=+S[3]*(V[32]*(64*V[32]-128*V[33])+64*S[0]);
C[39]=+S[1]*(V[32]*(24*V[33]+12*V[32])+12*S[0]);
C[38]=+V[32]*(24*V[32]-48*V[33])+24*S[0];
C[37]=+S[1]*(V[32]*(8*V[33]+4*V[32])+4*S[0]);
C[36]=+S[1]*(V[32]*(16*V[33]+8*V[32])+8*S[0]);
C[35]=+V[32]*(120*V[32]-240*V[33])+120*S[0];
C[34]=+V[32]*(192*V[32]-384*V[33])+192*S[0];
C[33]=+V[32]*(32*V[32]-64*V[33])+32*S[0];
C[32]=+V[32]*(160*V[32]-320*V[33])+160*S[0];
C[31]=+V[32]*(96*V[32]-192*V[33])+96*S[0];
C[30]=+V[32]*(64*V[32]-128*V[33])+64*S[0];
C[29]=+S[3]*(S[1]*(V[32]*(28*V[33]+14*V[32])+14*S[0]));
C[28]=+S[3]*(V[32]*(4*V[32]-8*V[33])+4*S[0]);
C[27]=+S[3]*(S[1]*(V[32]*(20*V[33]+10*V[32])+10*S[0]));
C[26]=+S[3]*(V[32]*(20*V[32]-40*V[33])+20*S[0]);
C[25]=+S[3]*(S[1]*(V[32]*(16*V[33]+8*V[32])+8*S[0]));
C[24]=+S[3]*(V[32]*(36*V[32]-72*V[33])+36*S[0]);
C[23]=+S[3]*(S[1]*(V[32]*(32*V[33]+16*V[32])+16*S[0]));
C[22]=+S[3]*(V[32]*(8*V[32]-16*V[33])+8*S[0]);
...
C[17]=+S[2]*(S[1]*(V[32]*(2*V[33]+V[32])+S[0]));
C[16]=+S[3]*(S[1]*(V[32]*(4*V[33]+2*V[32])+2*S[0]));
C[15]=+S[2]*(S[1]*(V[32]*(4*V[33]+2*V[32])+2*S[0]));
C[14]=+S[2]*(V[32]*(30*V[32]-60*V[33])+30*S[0]);
C[13]=+S[3]*(S[1]*(V[32]*(8*V[33]+4*V[32])+4*S[0]));
C[12]=+S[3]*(V[32]*(60*V[32]-120*V[33])+60*S[0]);
C[11]=+S[2]*(V[32]*(48*V[32]-96*V[33])+48*S[0]);
C[10]=+S[3]*(V[32]*(96*V[32]-192*V[33])+96*S[0]);
C[9]=+S[2]*(V[32]*(8*V[32]-16*V[33])+8*S[0]);
C[8]=+S[3]*(V[32]*(16*V[32]-32*V[33])+16*S[0]);
C[7]=+S[2]*(V[32]*(40*V[32]-80*V[33])+40*S[0]);
C[6]=+S[3]*(V[32]*(80*V[32]-160*V[33])+80*S[0]);
...
REAL F1007_out(double GG,REAL*DP,REAL*Q0,REAL*Q1,REAL*Q2)
{
/*
                                     !  u                 G          
                                    /!==>==============@---1-        
