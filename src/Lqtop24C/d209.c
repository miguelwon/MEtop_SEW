...
#include"num_in.h"
#include"num_out.h"
extern FNN F803_out,F804_out,F805_out,F806_out,F807_out,F808_out;
static FNN *Farr[6]={&F803_out,&F804_out,&F805_out,&F806_out,&F807_out
 ,&F808_out};
extern DNN S209_out;
REAL S209_out(double GG, REAL * momenta,int * err)
{REAL  ans=0;
REAL DP[15];
REAL* V=va_out;
REAL mass[6],width[6];
