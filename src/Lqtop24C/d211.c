...
#include"num_in.h"
#include"num_out.h"
extern FNN F810_out,F811_out,F812_out,F813_out,F814_out,F815_out;
static FNN *Farr[6]={&F810_out,&F811_out,&F812_out,&F813_out,&F814_out
 ,&F815_out};
extern DNN S211_out;
REAL S211_out(double GG, REAL * momenta,int * err)
{REAL  ans=0;
REAL DP[15];
REAL* V=va_out;
REAL mass[6],width[6];
