...
C[37]=+S[4]*(S[0]*(V[32]*(S[1]*(-2*V[33]-V[32])+S[0]*(4*V[32]-8*V[33]))+
 S[2]*(4*S[0]-S[1])));
...
C[31]=+S[5]*(S[0]*(V[32]*(S[1]*(-8*V[33]-4*V[32])+S[0]*(16*V[32]-32*V[33]))+
 S[2]*(16*S[0]-4*S[1])));
C[30]=+S[0]*(V[32]*(S[1]*(-8*V[33]-4*V[32])+S[0]*(16*V[32]-32*V[33]))+S[2]*(
 16*S[0]-4*S[1]));
...
C[21]=+S[0]*(V[32]*(8*V[32]-16*V[33])+8*S[2]);
...
C[15]=+S[5]*(S[0]*(V[32]*(S[1]*(-4*V[33]-2*V[32])+S[0]*(8*V[32]-16*V[33]))+
 S[2]*(8*S[0]-2*S[1])));
...
REAL F323_out(double GG,REAL*DP,REAL*Q0,REAL*Q1,REAL*Q2)
{
/*
                           N2     !  N2                              
                        /==<======!==<==\                            
