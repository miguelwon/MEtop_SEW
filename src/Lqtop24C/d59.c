...
#include"num_in.h"
#include"num_out.h"
extern FNN F357_out,F358_out,F359_out,F360_out,F361_out,F362_out,F363_out;
static FNN *Farr[7]={&F357_out,&F358_out,&F359_out,&F360_out,&F361_out
 ,&F362_out,&F363_out};
extern DNN S59_out;
REAL S59_out(double GG, REAL * momenta,int * err)
{REAL  ans=0;
REAL DP[15];
REAL* V=va_out;
REAL mass[6],width[6];
