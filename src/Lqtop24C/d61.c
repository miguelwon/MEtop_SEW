...
#include"num_in.h"
#include"num_out.h"
extern FNN F365_out,F366_out,F367_out,F368_out,F369_out,F370_out,F371_out;
static FNN *Farr[7]={&F365_out,&F366_out,&F367_out,&F368_out,&F369_out
 ,&F370_out,&F371_out};
extern DNN S61_out;
REAL S61_out(double GG, REAL * momenta,int * err)
{REAL  ans=0;
REAL DP[15];
REAL* V=va_out;
REAL mass[6],width[6];
