...
#include"num_in.h"
#include"num_out.h"
extern FNN F302_out,F303_out,F304_out,F305_out,F306_out,F307_out;
static FNN *Farr[6]={&F302_out,&F303_out,&F304_out,&F305_out,&F306_out
 ,&F307_out};
extern DNN S52_out;
REAL S52_out(double GG, REAL * momenta,int * err)
{REAL  ans=0;
REAL DP[15];
REAL* V=va_out;
REAL mass[6],width[6];
