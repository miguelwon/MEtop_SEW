...
#include"num_in.h"
#include"num_out.h"
extern FNN F119_out,F120_out,F121_out,F122_out,F123_out,F124_out;
static FNN *Farr[6]={&F119_out,&F120_out,&F121_out,&F122_out,&F123_out
 ,&F124_out};
extern DNN S22_out;
REAL S22_out(double GG, REAL * momenta,int * err)
{REAL  ans=0;
REAL DP[15];
REAL* V=va_out;
REAL mass[6],width[6];
