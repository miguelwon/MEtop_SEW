...
#include"num_in.h"
#include"num_out.h"
extern FNN F77_out,F78_out,F79_out,F80_out,F81_out,F82_out,F83_out;
static FNN *Farr[7]={&F77_out,&F78_out,&F79_out,&F80_out,&F81_out,&F82_out
 ,&F83_out};
extern DNN S13_out;
REAL S13_out(double GG, REAL * momenta,int * err)
{REAL  ans=0;
REAL DP[15];
REAL* V=va_out;
REAL mass[6],width[6];
