...
C[129]=+S[4]*(S[2]*(S[0]*(4*(S[3]+S[0]))));
C[128]=+S[2]*(S[1]*(S[0]*(8*(S[3]+S[0]+S[1]))));
C[127]=+S[4]*(S[3]*(S[0]*(12*S[3]+2*S[0])+2*S[2]));
S[5]=V[10]*V[10]*V[10]*V[10];
C[126]=+S[1]*(S[3]*(4*(S[1]*(S[3]+S[0])+S[2]+S[5])+24*S[3]*S[0]));
C[125]=+S[4]*(S[3]*(4*(S[3]+S[0])));
C[124]=+S[1]*(S[0]*(S[1]*(2*(S[3]+S[0]))+8*S[2]));
C[123]=+S[1]*(S[0]*(4*(S[3]+S[0]+S[1])));
C[122]=+S[1]*(4*(S[3]*(S[3]+S[0]-S[1])+S[0]*S[1]));
C[121]=+S[1]*(8*(S[3]-S[0]-S[1]));
C[120]=+4*S[2]*S[0]*S[4];
C[119]=+S[1]*(S[0]*(S[3]*(8*S[3]+4*S[1])));
C[118]=+S[4]*(S[3]*(2*(S[3]+S[0])));
C[117]=+S[4]*(4*(S[3]-S[0]));
C[116]=+S[2]*(S[1]*(S[0]*(16*(S[3]+S[0]))));
C[115]=+32*S[2]*S[0]*S[1];
C[114]=+S[1]*(S[3]*(S[0]*(48*S[3]+8*S[0])+8*S[2]));
C[113]=+S[1]*(S[3]*(16*(S[3]+S[0])));
C[112]=+S[2]*(S[0]*(16*(S[3]+S[0]+S[1])));
C[111]=+32*S[2]*S[0];
C[110]=+S[3]*(8*(S[1]*(S[3]+S[0])+S[2]+S[5])+48*S[3]*S[0]);
C[109]=+S[3]*(16*(S[3]+S[0]));
C[108]=+16*S[2]*S[1];
C[107]=+S[1]*(S[0]*(8*(S[3]+S[0])));
C[106]=+S[2]*(16*S[0]+8*S[1]);
C[105]=+S[3]*(16*(S[3]-S[1]));
C[104]=+S[0]*(S[1]*(4*(S[3]+S[0]))+16*S[2]);
C[103]=+S[0]*(8*(S[3]+S[0]+S[1]));
C[102]=+16*S[0];
C[101]=+8*(S[3]*(S[3]+S[0]-S[1])+S[0]*S[1]);
C[100]=+S[1]*(S[0]*(8*(S[3]-S[0]))+16*S[2]);
C[99]=+S[1]*(S[0]*(4*(S[3]-S[0]))+8*S[2])+16*S[2]*S[0];
C[98]=+S[0]*(8*(S[3]-S[0]))+16*S[2];
C[97]=+8*(S[3]*(S[3]+S[0]+S[1])-S[0]*S[1]);
C[96]=+S[0]*(S[3]*(16*S[3]+8*S[1]));
C[95]=+16*S[3]*S[0];
C[94]=+S[3]*(8*(S[3]+S[0]));
C[93]=+16*(S[3]-S[0]-S[1]);
C[92]=+S[1]*(16*(S[3]-S[0]));
C[91]=+16*(S[3]-S[0]);
C[90]=+S[5]*(S[1]*(S[3]*(8*(S[3]+S[0]))));
C[89]=+16*S[3]*S[5]*S[1];
C[88]=+S[1]*(S[0]*(S[0]*(40*S[3]+4*S[0])+20*S[2]));
C[87]=+S[1]*(S[0]*(40*S[3]+8*S[0]));
C[86]=+S[1]*(S[0]*(56*S[3]+16*S[0])+8*S[2]);
C[85]=+S[1]*(S[3]*(16*S[3]+48*S[0]));
C[84]=+S[1]*(48*S[3]+16*S[0]);
C[83]=+32*S[3]*S[1];
C[82]=+S[1]*(S[0]*(S[3]*(32*(S[3]+S[0]))));
C[81]=+S[1]*(S[0]*(48*S[3]+16*S[0]));
C[80]=+S[1]*(S[0]*(96*S[3]+16*S[0])+16*S[2]);
C[79]=+S[1]*(16*S[3]+48*S[0]);
C[78]=+64*S[3]*S[0]*S[1];
C[77]=+32*S[1];
C[76]=+S[1]*(32*(S[3]+S[0]));
C[75]=+32*S[0]*S[1];
C[74]=+S[5]*(S[3]*(8*(S[3]+S[0]+S[1])));
C[73]=+16*S[3]*S[5];
C[72]=+S[0]*(S[0]*(4*(S[0]+S[1])+40*S[3])+S[3]*(20*(S[3]+S[1])));
C[71]=+S[0]*(40*S[3]+8*S[0]);
C[70]=+S[0]*(56*S[3]+16*S[0]+8*S[1])+S[3]*(8*(S[3]+S[1]));
...
C[55]=+32*S[0];
C[54]=+16*(S[3]+S[0]);
C[53]=+S[2]*(S[1]*(S[0]*(8*(S[3]+S[0]))));
C[52]=+16*S[2]*S[0]*S[1];
C[51]=+S[1]*(S[3]*(S[0]*(24*S[3]+4*S[0])+4*S[2]));
C[50]=+S[1]*(S[3]*(8*(S[3]+S[0])));
C[49]=+8*S[2]*S[1];
C[48]=+S[1]*(S[0]*(4*(S[3]+S[0])));
C[47]=+8*S[0]*S[1];
C[46]=+S[1]*(S[0]*(4*(S[3]-S[0]))+8*S[2]);
C[45]=+8*S[2]*S[0]*S[1];
C[44]=+8*S[3]*S[0]*S[1];
C[43]=+S[1]*(S[3]*(4*(S[3]+S[0])));
C[42]=+S[1]*(8*(S[3]-S[0]));
C[41]=+S[4]*(S[5]*(S[3]*(2*(S[3]+S[0]))));
C[40]=+S[5]*(S[1]*(S[3]*(4*(S[3]+S[0]+S[1]))));
C[39]=+S[4]*(S[0]*(S[0]*(10*S[3]+S[0])+5*S[2]));
C[38]=+S[1]*(S[0]*(S[0]*(2*(S[0]+S[1])+20*S[3])+S[3]*(10*(S[3]+S[1]))));
C[37]=+S[4]*(S[0]*(14*S[3]+4*S[0])+2*S[2]);
C[36]=+S[1]*(S[0]*(28*S[3]+8*S[0]+4*S[1])+S[3]*(4*(S[3]+S[1])));
C[35]=+S[5]*(S[1]*(S[3]*(4*(S[3]+S[0]))));
C[34]=+8*S[3]*S[5]*S[1];
C[33]=+S[1]*(S[0]*(S[0]*(20*S[3]+2*S[0])+10*S[2]));
C[32]=+S[1]*(S[0]*(20*S[3]+4*S[0]));
C[31]=+S[1]*(S[0]*(28*S[3]+8*S[0])+4*S[2]);
...
REAL F614_out(double GG,REAL*DP,REAL*Q0,REAL*Q1,REAL*Q2)
{
/*
   C                       N2     !  N2                      C       
 ==<==\                 /==<======!==<==\                 /==<==     
...
tmp[0]=+DP[12]*(C[42]*(DP[7]*(DP[1]-DP[2]+DP[3]-DP[4])+DP[0]*(DP[2]+DP[4])+
 ...
 C[13]*DP[7])+DP[11]*(DP[5]*(C[42]*(DP[6]-DP[0]+DP[7])+C[48])+C[117]*(DP[6]+
 DP[7])+C[124]+C[122]*DP[0])+DP[10]*(DP[5]*(C[49]-C[42]*DP[7])+C[134]+C[43]*
 DP[0]-C[117]*DP[7]);
tmp[1]=+DP[7]*(DP[0]*(C[42]*(DP[1]*(-DP[12]-DP[13])+DP[3]*(-DP[12]-DP[13])+
 DP[10]*(DP[5]-S[1]))+C[15]*(DP[8]*(-DP[12]-DP[13])+DP[9]*(-DP[12]-DP[13])+
 DP[14]*(DP[5]-S[1]))+DP[14]*(C[19]+C[8]*DP[0]-C[2]*DP[7])+C[130]*DP[10]+
 C[43]*DP[11])+DP[7]*(C[42]*(DP[1]*(DP[12]+DP[13])+DP[3]*(DP[12]+DP[13])+
 DP[10]*(S[1]-DP[5]))+C[3]*(DP[8]*(DP[12]+DP[13])+DP[9]*(DP[12]+DP[13])+
 DP[14]*(S[1]-DP[5]))-C[117]*DP[10]-C[6]*DP[14])+DP[12]*(C[46]*(-DP[1]-
 ...
 C[131]*DP[10]+C[119]*DP[11]+C[21]*DP[14])+DP[0]*(C[50]*(DP[12]*(DP[1]+
 ...
 DP[12]+DP[13])+DP[9]*(DP[12]+DP[13])+DP[14]*(S[1]-DP[5]))+C[126]*(-DP[10]-
 ...
 C[128]*(-DP[10]-DP[11])-C[40]*DP[14];
tmp[2]=+DP[6]*(S[1]*(S[1]*(32*(DP[0]*(DP[9]-DP[3])+DP[7]*(DP[3]-DP[9])-
 DP[6]*DP[4])+C[64]*(DP[9]-DP[3])+C[102]*DP[4])+DP[0]*(C[77]*(DP[1]-DP[8])+
 C[9]*DP[3]+C[91]*DP[4]-C[66]*DP[9])+DP[7]*(C[77]*(DP[8]-DP[1])+C[93]*DP[3]-
 C[91]*DP[4]+C[58]*DP[9])+DP[6]*(C[77]*DP[2]-C[93]*DP[4]+C[64]*DP[9])+C[83]*
 (DP[1]-DP[8])-C[3]*DP[2]-C[105]*DP[3]-C[103]*DP[4]-C[68]*DP[9])+DP[0]*(
 DP[9]*(C[57]*(DP[0]-DP[7])+C[67]-C[54]*DP[6])+C[94]*DP[3]-C[92]*DP[2]+
 C[101]*DP[4]+C[84]*DP[8])+DP[7]*(C[92]*(DP[2]-DP[1])+C[42]*(DP[4]-DP[3])-
 C[76]*DP[8]-C[59]*DP[9])+DP[6]*(C[92]*DP[2]+C[42]*DP[4]-C[83]*DP[8]-C[65]*
 DP[9])+C[108]*DP[1]+C[107]*DP[2]+C[106]*DP[3]+C[104]*DP[4]+C[85]*DP[8]+
 C[69]*DP[9])+DP[0]*(DP[7]*(DP[9]*(C[61]-C[60]*S[1]+C[57]*DP[0]-C[54]*
 DP[7])+DP[3]*(C[97]-C[91]*S[1])+C[92]*DP[1]+C[94]*DP[4]+C[79]*DP[8])+DP[0]*
 (DP[9]*(C[54]*(S[1]-DP[0])-C[70])+C[109]*(-DP[3]-DP[4])-C[8]*DP[8])+S[1]*(
 C[109]*(DP[3]+DP[4])+C[71]*DP[9])+C[113]*(-DP[1]-DP[2])+C[110]*(-DP[3]-
 DP[4])-C[87]*DP[8]-C[72]*DP[9])+DP[7]*(DP[7]*(S[1]*(C[91]*DP[3]+C[55]*
 DP[9])-C[92]*DP[1]-C[42]*DP[3]-C[75]*DP[8]-C[56]*DP[9])+S[1]*(-C[98]*DP[3]-
 C[95]*DP[4]-C[62]*DP[9])+C[100]*DP[1]+C[4]*DP[2]+C[99]*DP[3]+C[96]*DP[4]+
 C[81]*DP[8]+C[63]*DP[9])+S[1]*(C[111]*(DP[3]+DP[4])+C[73]*DP[9])+C[115]*(-
 DP[1]-DP[2])+C[112]*(-DP[3]-DP[4])-C[89]*DP[8]-C[74]*DP[9];
...
tmp[5]=+DP[0]*(DP[0]*(DP[12]*(DP[8]*(C[8]*(DP[6]+DP[7])-C[31]-C[2]*DP[0])+
 ...
 C[5]*DP[0])+DP[5]*(C[50]*(DP[10]+DP[11]))+C[125]*(DP[10]+DP[11]))+DP[6]*(
 ...
 C[11]*DP[7])+DP[5]*(C[43]*(-DP[10]-DP[11]))+C[118]*(-DP[10]-DP[11]))+DP[7]*
...
tmp[6]=+DP[5]*(DP[6]*(DP[12]*(C[45]*(DP[1]+DP[2]+DP[3]+DP[4])+DP[8]*(C[18]-
 ...
 DP[7])+C[7]*DP[6]-C[22]+C[14]*DP[7])+DP[5]*(C[45]*(-DP[10]-DP[11]))+C[120]*
 ...
 DP[8]*(DP[12]+DP[13])+DP[9]*(DP[12]+DP[13])-DP[14]*DP[5])+C[120]*(-DP[10]-
 DP[11])-C[22]*DP[14])+C[53]*(DP[12]*(-DP[1]-DP[2]-DP[3]-DP[4])+DP[13]*(-
 DP[1]-DP[2]-DP[3]-DP[4])+DP[5]*(DP[10]+DP[11]))+C[35]*(DP[8]*(-DP[12]-
 DP[13])+DP[9]*(-DP[12]-DP[13])+DP[14]*DP[5])+C[129]*(DP[10]+DP[11])+C[41]*
 DP[14]+tmp[5]);
R=+S[1]*(DP[5]*(DP[6]*(S[1]*(C[9]*(DP[0]*(DP[12]*(DP[8]-DP[1]-DP[3]+DP[9])+
 ...
 C[123]-C[121]*DP[6])+C[47]*(DP[2]*(DP[12]+DP[13])+DP[4]*(DP[12]+DP[13]))+
 DP[10]*(C[132]*DP[0]-C[133]+C[121]*DP[7])+DP[14]*(C[12]*DP[7]-C[29]-C[27]*
