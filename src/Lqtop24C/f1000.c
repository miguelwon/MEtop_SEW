...
#include"num_out.h"
#include"num_in.h"
extern FNN F1000_out;
static void C1000(REAL * C)
{
REAL* V=va_out;
REAL S[10];                                                                 
...
S[2]=V[35]*V[35];
S[3]=V[9]*V[9]*V[9]*V[9];
C[20]=+S[3]*(S[1]*(V[34]*(S[1]*(2*V[35]-V[34])+S[0]*(2*V[35]+V[34]))+S[2]*(
 S[0]-S[1])));
C[19]=+S[3]*(V[34]*(S[1]*(V[34]-2*V[35])+S[0]*(2*V[35]+V[34]))+S[2]*(S[0]+
 S[1]));
S[4]=V[9]*V[9];
C[18]=+S[4]*(S[1]*(V[34]*(S[1]*(8*V[35]-4*V[34])+S[0]*(8*V[35]+4*V[34]))+
 S[2]*(4*(S[0]-S[1]))));
C[17]=+S[1]*(V[34]*(S[1]*(8*V[35]-4*V[34])+S[0]*(8*V[35]+4*V[34]))+S[2]*(4*(
 S[0]-S[1])));
C[16]=+S[4]*(V[34]*(S[1]*(4*V[34]-8*V[35])+S[0]*(8*V[35]+4*V[34]))+S[2]*(4*(
 S[0]+S[1])));
C[15]=+V[34]*(S[1]*(4*V[34]-8*V[35])+S[0]*(8*V[35]+4*V[34]))+S[2]*(4*(S[0]+
 S[1]));
C[14]=+S[4]*(S[1]*(V[34]*(16*V[34]-32*V[35])+16*S[2]));
C[13]=+S[4]*(V[34]*(8*V[34]-16*V[35])+8*S[2]);
C[12]=+S[1]*(V[34]*(16*V[34]-32*V[35])+16*S[2]);
C[11]=+S[1]*(V[34]*(8*V[34]-16*V[35])+8*S[2]);
C[10]=+V[34]*(8*V[34]-16*V[35])+8*S[2];
C[9]=+S[4]*(S[1]*(V[34]*(S[1]*(4*V[35]-2*V[34])+S[0]*(4*V[35]+2*V[34]))+
 S[2]*(2*(S[0]-S[1]))));
C[8]=+S[4]*(V[34]*(S[1]*(2*V[34]-4*V[35])+S[0]*(4*V[35]+2*V[34]))+S[2]*(2*(
 S[0]+S[1])));
C[7]=+S[3]*(S[1]*(V[34]*(4*V[34]-8*V[35])+4*S[2]));
C[6]=+S[4]*(S[1]*(V[34]*(8*V[34]-16*V[35])+8*S[2]));
C[5]=+S[3]*(S[1]*(V[34]*(2*V[34]-4*V[35])+2*S[2]));
C[4]=+S[4]*(S[1]*(V[34]*(4*V[34]-8*V[35])+4*S[2]));
...
REAL F1000_out(double GG,REAL*DP,REAL*Q0,REAL*Q1,REAL*Q2)
{
/*
                           n2     !  n2                              
                        /==>======!==>==\                            
