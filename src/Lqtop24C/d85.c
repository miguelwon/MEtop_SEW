...
#include"num_in.h"
#include"num_out.h"
extern FNN F444_out,F445_out,F446_out,F447_out,F448_out,F449_out,F450_out;
static FNN *Farr[7]={&F444_out,&F445_out,&F446_out,&F447_out,&F448_out
 ,&F449_out,&F450_out};
extern DNN S85_out;
REAL S85_out(double GG, REAL * momenta,int * err)
{REAL  ans=0;
REAL DP[15];
REAL* V=va_out;
REAL mass[6],width[6];
