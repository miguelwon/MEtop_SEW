...
#include"num_in.h"
#include"num_out.h"
extern FNN F527_out,F528_out,F529_out,F530_out,F531_out,F532_out,F533_out;
static FNN *Farr[7]={&F527_out,&F528_out,&F529_out,&F530_out,&F531_out
 ,&F532_out,&F533_out};
extern DNN S116_out;
REAL S116_out(double GG, REAL * momenta,int * err)
{REAL  ans=0;
REAL DP[15];
REAL* V=va_out;
REAL mass[6],width[6];
