...
tmp[0]=+V[50]*(DP[12]*(V[50]*(V[50]*(V[50]*(V[50]*(C[10]*(DP[6]*DP[4]+DP[7]*
 DP[3]-DP[9]*DP[0])+C[14]*DP[7]*DP[4])+C[11]*(DP[6]*DP[4]+DP[7]*DP[3]-DP[9]*
 DP[0]))+DP[7]*(C[12]*DP[3]-C[8]*DP[1]-C[16]*DP[2]+C[15]*DP[4])+DP[0]*(C[8]*
 DP[8]-C[12]*DP[9])+DP[6]*(C[12]*DP[4]-C[8]*DP[2]))+C[13]*(DP[8]*DP[0]-
 DP[6]*DP[2]-DP[7]*DP[1])+C[3]*(DP[9]*DP[0]-DP[6]*DP[4]-DP[7]*DP[3]))+DP[5]*
 (C[2]*(DP[0]*(-DP[8]-DP[9])+DP[6]*(DP[2]+DP[4])+DP[7]*(DP[1]+DP[3]))+DP[7]*
 (C[8]*(DP[2]+DP[4])))+DP[7]*(C[9]*(-DP[1]-DP[4])-C[17]*DP[2]-C[4]*DP[3])+
 DP[0]*(C[9]*DP[8]+C[4]*DP[9])+DP[6]*(-C[9]*DP[2]-C[4]*DP[4]))+DP[5]*(C[2]*(
 DP[13]*(DP[0]*(-DP[8]-DP[9])+DP[6]*(DP[2]+DP[4])+DP[7]*(DP[1]+DP[3]))+S[1]*
 (DP[10]*DP[7]+DP[11]*DP[6]-DP[14]*DP[0])+DP[5]*(DP[14]*DP[0]-DP[10]*DP[7]-
 DP[11]*DP[6]))+DP[7]*(C[8]*(DP[11]*(S[1]-DP[5])+DP[13]*(DP[2]+DP[4]))+
 DP[10]*(C[5]+C[3]*V[50])+C[18]*DP[11])+V[50]*(C[3]*(DP[11]*DP[6]-DP[14]*
 DP[0]))+C[5]*(DP[11]*DP[6]-DP[14]*DP[0]))+DP[13]*(V[50]*(V[50]*(C[2]*(
 DP[8]*DP[0]-DP[6]*DP[2]-DP[7]*DP[1])-C[8]*DP[7]*DP[2])+C[3]*(DP[8]*DP[0]-
...
R=+DP[0]*(V[50]*(DP[5]*(C[3]*(DP[12]*(DP[0]*(-DP[8]-DP[9])+DP[6]*(DP[2]+
 ...
 DP[5]*(DP[14]*DP[0]-DP[10]*DP[7]-DP[11]*DP[6]))+DP[7]*(C[9]*(DP[2]*(DP[12]+
 DP[13])+DP[4]*(DP[12]+DP[13])-DP[11]*DP[5])-C[7]*DP[10]-C[19]*DP[11])+C[7]*
 (DP[14]*DP[0]-DP[11]*DP[6])));
