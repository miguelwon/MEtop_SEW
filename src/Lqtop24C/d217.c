...
#include"num_in.h"
#include"num_out.h"
extern FNN F826_out,F827_out,F828_out,F829_out;
static FNN *Farr[4]={&F826_out,&F827_out,&F828_out,&F829_out};
extern DNN S217_out;
REAL S217_out(double GG, REAL * momenta,int * err)
{REAL  ans=0;
REAL DP[15];
REAL* V=va_out;
REAL mass[8],width[8];
char * Qtxt[8];
REAL Q0[8],Q1[8],Q2[8];
width[7]=0.; mass[7]=0;  Qtxt[7]="\1\6";
width[6]=0.; mass[6]=0;  Qtxt[6]="\1\5";
