...
#include"num_in.h"
#include"num_out.h"
extern FNN F403_out,F404_out,F405_out,F406_out,F407_out,F408_out;
static FNN *Farr[6]={&F403_out,&F404_out,&F405_out,&F406_out,&F407_out
 ,&F408_out};
extern DNN S77_out;
REAL S77_out(double GG, REAL * momenta,int * err)
{REAL  ans=0;
REAL DP[15];
REAL* V=va_out;
REAL mass[6],width[6];
