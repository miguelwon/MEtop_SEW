...
#include"num_in.h"
#include"num_out.h"
extern FNN F221_out,F222_out,F223_out,F224_out,F225_out,F226_out,F227_out;
static FNN *Farr[7]={&F221_out,&F222_out,&F223_out,&F224_out,&F225_out
 ,&F226_out,&F227_out};
extern DNN S36_out;
REAL S36_out(double GG, REAL * momenta,int * err)
{REAL  ans=0;
REAL DP[15];
REAL* V=va_out;
REAL mass[6],width[6];
