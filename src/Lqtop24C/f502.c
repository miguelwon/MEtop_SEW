...
REAL F502_out(double GG,REAL*DP,REAL*Q0,REAL*Q1,REAL*Q2)
{
/*
         c                 c      !  c                 c             
       ==>==@==============>======!==>==============@==>==           
