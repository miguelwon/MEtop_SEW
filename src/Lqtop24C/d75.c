...
#include"num_in.h"
#include"num_out.h"
extern FNN F396_out,F397_out,F398_out,F399_out,F400_out,F401_out;
static FNN *Farr[6]={&F396_out,&F397_out,&F398_out,&F399_out,&F400_out
 ,&F401_out};
extern DNN S75_out;
REAL S75_out(double GG, REAL * momenta,int * err)
{REAL  ans=0;
REAL DP[15];
REAL* V=va_out;
REAL mass[6],width[6];
