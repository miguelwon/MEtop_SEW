...
C[31]=+S[1]*(V[2]*(V[20]*(8*V[37]*V[22]+4*V[20]*V[2]))+4*S[4]*S[3]);
S[7]=V[14]*V[14]*V[14]*V[14];
C[30]=+S[7]*(S[6]*(V[2]*(S[1]*(V[20]*(-8*V[37]*V[22]-4*V[20]*V[2]))+S[0]*(
 V[21]*(16*V[37]*V[23]+8*V[21]*V[2])))+S[4]*(8*S[2]*S[0]-4*S[3]*S[1])));
C[29]=+S[6]*(S[0]*(V[2]*(S[1]*(V[20]*(-8*V[37]*V[22]-4*V[20]*V[2]))+S[0]*(
 V[21]*(32*V[37]*V[23]+16*V[21]*V[2])))+S[4]*(16*S[2]*S[0]-4*S[3]*S[1])));
C[28]=+S[7]*(S[6]*(V[2]*(V[21]*(48*V[37]*V[23]+24*V[21]*V[2]))+24*S[4]*
 S[2]));
C[27]=+S[6]*(S[0]*(V[2]*(V[21]*(64*V[37]*V[23]+32*V[21]*V[2]))+32*S[4]*
 S[2]));
C[26]=+S[6]*(V[2]*(V[21]*(16*V[37]*V[23]+8*V[21]*V[2]))+8*S[4]*S[2]);
C[25]=+S[7]*(V[2]*(S[1]*(V[20]*(-8*V[37]*V[22]-4*V[20]*V[2]))+S[0]*(V[21]*(
 16*V[37]*V[23]+8*V[21]*V[2])))+S[4]*(8*S[2]*S[0]-4*S[3]*S[1]));
C[24]=+S[0]*(V[2]*(S[1]*(V[20]*(-8*V[37]*V[22]-4*V[20]*V[2]))+S[0]*(V[21]*(
 32*V[37]*V[23]+16*V[21]*V[2])))+S[4]*(16*S[2]*S[0]-4*S[3]*S[1]));
C[23]=+S[0]*(V[2]*(V[21]*(16*V[37]*V[23]+8*V[21]*V[2]))+8*S[4]*S[2]);
C[22]=+S[7]*(V[2]*(V[21]*(48*V[37]*V[23]+24*V[21]*V[2]))+24*S[4]*S[2]);
C[21]=+S[0]*(V[2]*(V[21]*(64*V[37]*V[23]+32*V[21]*V[2]))+32*S[4]*S[2]);
C[20]=+S[0]*(V[2]*(V[21]*(32*V[37]*V[23]+16*V[21]*V[2]))+16*S[4]*S[2]);
C[19]=+V[2]*(V[21]*(16*V[37]*V[23]+8*V[21]*V[2]))+8*S[4]*S[2];
C[18]=+S[6]*(S[0]*(V[2]*(S[1]*(V[20]*(4*V[37]*V[22]+2*V[20]*V[2]))+S[0]*(
 V[21]*(8*V[37]*V[23]+4*V[21]*V[2])))+S[4]*(4*S[2]*S[0]+2*S[3]*S[1])));
C[17]=+S[6]*(S[1]*(S[0]*(V[2]*(V[20]*(8*V[37]*V[22]+4*V[20]*V[2]))+4*S[4]*
 S[3])));
C[16]=+S[6]*(S[1]*(V[2]*(V[20]*(4*V[37]*V[22]+2*V[20]*V[2]))+2*S[4]*S[3]));
C[15]=+S[5]*(S[7]*(V[2]*(S[1]*(V[20]*(-2*V[37]*V[22]-V[20]*V[2]))+S[0]*(
 V[21]*(4*V[37]*V[23]+2*V[21]*V[2])))+S[4]*(2*S[2]*S[0]-S[3]*S[1])));
C[14]=+S[5]*(S[0]*(V[2]*(S[1]*(V[20]*(-2*V[37]*V[22]-V[20]*V[2]))+S[0]*(
 V[21]*(8*V[37]*V[23]+4*V[21]*V[2])))+S[4]*(4*S[2]*S[0]-S[3]*S[1])));
C[13]=+S[5]*(S[0]*(V[2]*(V[21]*(4*V[37]*V[23]+2*V[21]*V[2]))+2*S[4]*S[2]));
C[12]=+S[7]*(S[6]*(V[2]*(S[1]*(V[20]*(-4*V[37]*V[22]-2*V[20]*V[2]))+S[0]*(
 V[21]*(8*V[37]*V[23]+4*V[21]*V[2])))+S[4]*(4*S[2]*S[0]-2*S[3]*S[1])));
C[11]=+S[6]*(S[0]*(V[2]*(S[1]*(V[20]*(-4*V[37]*V[22]-2*V[20]*V[2]))+S[0]*(
 V[21]*(16*V[37]*V[23]+8*V[21]*V[2])))+S[4]*(8*S[2]*S[0]-2*S[3]*S[1])));
C[10]=+S[6]*(S[0]*(V[2]*(V[21]*(8*V[37]*V[23]+4*V[21]*V[2]))+4*S[4]*S[2]));
C[9]=+S[5]*(S[7]*(V[2]*(V[21]*(12*V[37]*V[23]+6*V[21]*V[2]))+6*S[4]*S[2]));
C[8]=+S[5]*(S[0]*(V[2]*(V[21]*(16*V[37]*V[23]+8*V[21]*V[2]))+8*S[4]*S[2]));
C[7]=+S[7]*(S[6]*(V[2]*(V[21]*(24*V[37]*V[23]+12*V[21]*V[2]))+12*S[4]*
 S[2]));
C[6]=+S[6]*(S[0]*(V[2]*(V[21]*(32*V[37]*V[23]+16*V[21]*V[2]))+16*S[4]*
 S[2]));
C[5]=+S[5]*(S[0]*(V[2]*(V[21]*(8*V[37]*V[23]+4*V[21]*V[2]))+4*S[4]*S[2]));
C[4]=+S[5]*(V[2]*(V[21]*(4*V[37]*V[23]+2*V[21]*V[2]))+2*S[4]*S[2]);
C[3]=+S[6]*(S[0]*(V[2]*(V[21]*(16*V[37]*V[23]+8*V[21]*V[2]))+8*S[4]*S[2]));
...
REAL F855_out(double GG,REAL*DP,REAL*Q0,REAL*Q1,REAL*Q2)
{
/*
   b                       N2     !  N2                      b       
 ==>==\                 /==<======!==<==\                 /==>==     
