...
#include"num_in.h"
#include"num_out.h"
extern FNN F331_out,F332_out,F333_out,F334_out,F335_out,F336_out,F337_out;
static FNN *Farr[7]={&F331_out,&F332_out,&F333_out,&F334_out,&F335_out
 ,&F336_out,&F337_out};
extern DNN S55_out;
REAL S55_out(double GG, REAL * momenta,int * err)
{REAL  ans=0;
REAL DP[15];
REAL* V=va_out;
REAL mass[6],width[6];
