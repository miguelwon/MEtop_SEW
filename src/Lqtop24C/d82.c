...
#include"num_in.h"
#include"num_out.h"
extern FNN F424_out,F425_out,F426_out,F427_out,F428_out,F429_out,F430_out;
static FNN *Farr[7]={&F424_out,&F425_out,&F426_out,&F427_out,&F428_out
 ,&F429_out,&F430_out};
extern DNN S82_out;
REAL S82_out(double GG, REAL * momenta,int * err)
{REAL  ans=0;
REAL DP[15];
REAL* V=va_out;
REAL mass[6],width[6];
