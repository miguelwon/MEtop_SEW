...
#include"num_in.h"
#include"num_out.h"
extern FNN F565_out,F566_out,F567_out,F568_out,F569_out,F570_out,F571_out;
static FNN *Farr[7]={&F565_out,&F566_out,&F567_out,&F568_out,&F569_out
 ,&F570_out,&F571_out};
extern DNN S133_out;
REAL S133_out(double GG, REAL * momenta,int * err)
{REAL  ans=0;
REAL DP[15];
REAL* V=va_out;
REAL mass[6],width[6];
