...
C[48]=+S[9]*(S[7]*(V[1]*(V[12]*(V[36]*(V[37]*(V[2]*(V[2]*(64*(V[2]*(V[23]*(
 V[24]-V[25]))+V[21]*(V[37]*(V[25]-V[24]))))+V[23]*(48*(V[25]-V[24])))+
 V[21]*(V[37]*(48*(V[24]-V[25])))))))));
S[12]=V[24]*V[24];
S[13]=V[25]*V[25];
C[47]=+S[9]*(V[2]*(V[2]*(S[7]*(S[6]*(S[5]*(V[31]*(V[37]*(V[2]*(192*(V[37]*
 V[21]-V[23]*V[2]))+144*V[23])))))+S[11]*(V[1]*(16*(S[12]-S[13]))))-144*
 S[10]*S[5]*V[31]*V[21]*S[6]*S[7])+S[11]*(V[1]*(12*(S[13]-S[12]))));
C[46]=+S[9]*(S[6]*(V[2]*(V[12]*(V[31]*(V[36]*(S[4]*(48*(V[25]+V[24]))+36*(-
 V[25]-V[24])))))));
C[45]=+S[9]*(V[1]*(V[12]*(V[36]*(V[37]*(V[2]*(V[2]*(64*(V[2]*(V[22]*(V[28]-
 ...
 V[24]))))))));
C[44]=+S[9]*(V[1]*(S[4]*(32*(S[1]-S[0]+S[2]-S[3])+64*(V[28]*V[26]-V[29]*
...
C[36]=+V[12]*(V[36]*(V[2]*(S[7]*(V[1]*(V[37]*(V[2]*(64*(V[2]*(V[23]*(V[24]-
 V[25]))+V[21]*(V[37]*(V[25]-V[24]))))+V[23]*(48*(V[25]-V[24])))))+S[9]*(
 S[6]*(V[31]*(S[4]*(24*(V[25]+V[24]))+18*(-V[25]-V[24])))))+S[7]*(S[10]*(
 V[1]*(V[21]*(48*(V[24]-V[25])))))));
C[35]=+V[2]*(V[2]*(S[7]*(S[6]*(S[5]*(V[31]*(V[37]*(V[2]*(192*(V[37]*V[21]-
 V[23]*V[2]))+144*V[23])))))+S[11]*(V[1]*(16*(S[12]-S[13]))))-144*S[10]*
 S[5]*V[31]*V[21]*S[6]*S[7])+S[11]*(V[1]*(12*(S[13]-S[12])));
C[34]=+S[6]*(V[2]*(V[12]*(V[31]*(V[36]*(S[4]*(48*(V[25]+V[24]))+36*(-V[25]-
 V[24]))))));
C[33]=+V[1]*(V[12]*(V[36]*(V[37]*(V[2]*(V[2]*(64*(V[2]*(V[22]*(V[28]-V[29]+
 ...
 V[24])))))));
C[32]=+V[1]*(S[4]*(32*(S[1]-S[0]+S[2]-S[3])+64*(V[28]*V[26]-V[29]*V[27]))+
...
REAL F279_out(double GG,REAL*DP,REAL*Q0,REAL*Q1,REAL*Q2)
{
/*
                           N2     !  N2                              
                        /==<======!==<==\                            
