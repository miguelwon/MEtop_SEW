...
#include"num_in.h"
#include"num_out.h"
extern FNN F475_out,F476_out,F477_out,F478_out,F479_out,F480_out;
static FNN *Farr[6]={&F475_out,&F476_out,&F477_out,&F478_out,&F479_out
 ,&F480_out};
extern DNN S99_out;
REAL S99_out(double GG, REAL * momenta,int * err)
{REAL  ans=0;
REAL DP[15];
REAL* V=va_out;
REAL mass[6],width[6];
