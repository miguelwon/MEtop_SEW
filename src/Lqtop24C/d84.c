...
#include"num_in.h"
#include"num_out.h"
extern FNN F432_out,F433_out,F434_out,F435_out,F436_out,F437_out,F438_out
 ,F439_out,F440_out,F441_out,F442_out,F443_out;
static FNN *Farr[12]={&F432_out,&F433_out,&F434_out,&F435_out,&F436_out
 ,&F437_out,&F438_out,&F439_out,&F440_out,&F441_out,&F442_out,&F443_out};
extern DNN S84_out;
REAL S84_out(double GG, REAL * momenta,int * err)
{REAL  ans=0;
REAL DP[15];
REAL* V=va_out;
