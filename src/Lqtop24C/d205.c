...
#include"num_in.h"
#include"num_out.h"
extern FNN F763_out,F764_out,F765_out,F766_out,F767_out,F768_out;
static FNN *Farr[6]={&F763_out,&F764_out,&F765_out,&F766_out,&F767_out
 ,&F768_out};
extern DNN S205_out;
REAL S205_out(double GG, REAL * momenta,int * err)
{REAL  ans=0;
REAL DP[15];
REAL* V=va_out;
REAL mass[6],width[6];
