...
S[1]=V[12]*V[12];
S[2]=V[9]*V[9]*V[9]*V[9];
C[18]=+S[2]*(S[1]*(V[32]*(4*V[33]+2*V[32])+2*S[0]));
S[3]=V[9]*V[9];
C[17]=+S[3]*(S[1]*(V[32]*(16*V[33]+8*V[32])+8*S[0]));
C[16]=+S[1]*(V[32]*(16*V[33]+8*V[32])+8*S[0]);
C[15]=+S[3]*(V[32]*(32*V[32]-64*V[33])+32*S[0]);
C[14]=+S[1]*(V[32]*(8*V[33]+4*V[32])+4*S[0]);
C[13]=+V[32]*(8*V[32]-16*V[33])+8*S[0];
C[12]=+V[32]*(32*V[32]-64*V[33])+32*S[0];
C[11]=+V[32]*(16*V[32]-32*V[33])+16*S[0];
C[10]=+S[3]*(S[1]*(V[32]*(8*V[33]+4*V[32])+4*S[0]));
...
C[4]=+S[3]*(V[32]*(16*V[32]-32*V[33])+16*S[0]);
...
REAL F970_out(double GG,REAL*DP,REAL*Q0,REAL*Q1,REAL*Q2)
{
/*
   G                       n2     !  n2                      G       
 -1---\                 /==>======!==>==\                 /---1-     
