...
#include"num_in.h"
#include"num_out.h"
extern FNN F517_out,F518_out,F519_out,F520_out,F521_out,F522_out,F523_out;
static FNN *Farr[7]={&F517_out,&F518_out,&F519_out,&F520_out,&F521_out
 ,&F522_out,&F523_out};
extern DNN S114_out;
REAL S114_out(double GG, REAL * momenta,int * err)
{REAL  ans=0;
REAL DP[15];
REAL* V=va_out;
REAL mass[6],width[6];
