...
S[1]=V[12]*V[12];
S[2]=V[9]*V[9];
C[12]=+S[2]*(S[1]*(V[32]*(8*V[33]+4*V[32])+4*S[0]));
C[11]=+S[2]*(V[32]*(16*V[32]-32*V[33])+16*S[0]);
C[10]=+S[1]*(V[32]*(8*V[33]+4*V[32])+4*S[0]);
C[9]=+V[32]*(8*V[32]-16*V[33])+8*S[0];
C[8]=+V[32]*(16*V[32]-32*V[33])+16*S[0];
S[3]=V[9]*V[9]*V[9]*V[9];
C[7]=+S[3]*(S[1]*(V[32]*(2*V[33]+V[32])+S[0]));
C[6]=+S[2]*(S[1]*(V[32]*(4*V[33]+2*V[32])+2*S[0]));
C[5]=+S[3]*(V[32]*(2*V[32]-4*V[33])+2*S[0]);
...
REAL F202_out(double GG,REAL*DP,REAL*Q0,REAL*Q1,REAL*Q2)
{
/*
         U                 U      !                                  
       ==<==@==============<==\   !                                  
