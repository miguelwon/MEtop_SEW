...
#include"num_in.h"
#include"num_out.h"
extern FNN F295_out,F296_out,F297_out,F298_out,F299_out,F300_out;
static FNN *Farr[6]={&F295_out,&F296_out,&F297_out,&F298_out,&F299_out
 ,&F300_out};
extern DNN S50_out;
REAL S50_out(double GG, REAL * momenta,int * err)
{REAL  ans=0;
REAL DP[15];
REAL* V=va_out;
REAL mass[6],width[6];
