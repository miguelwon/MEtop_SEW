...
#include"num_in.h"
#include"num_out.h"
extern FNN F581_out,F582_out,F583_out,F584_out,F585_out,F586_out,F587_out;
static FNN *Farr[7]={&F581_out,&F582_out,&F583_out,&F584_out,&F585_out
 ,&F586_out,&F587_out};
extern DNN S140_out;
REAL S140_out(double GG, REAL * momenta,int * err)
{REAL  ans=0;
REAL DP[15];
REAL* V=va_out;
REAL mass[6],width[6];
