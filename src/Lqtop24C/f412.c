...
REAL F412_out(double GG,REAL*DP,REAL*Q0,REAL*Q1,REAL*Q2)
{
/*
                                     !  D                 D          
                                    /!==<==============@==<==        
...
S[0]=V[50]*V[50]*V[50];
D=+C[1]*S[0];
tmp[0]=+V[50]*(V[50]*(DP[12]*(V[50]*(V[50]*(C[18]*(DP[0]*(DP[9]-DP[4])+
 DP[6]*(DP[4]-DP[9])-DP[7]*DP[3]))+C[22]*(DP[7]*DP[3]-DP[6]*DP[4]-DP[9]*
 DP[0])+C[19]*DP[9]*DP[6]-C[31]*DP[4]*DP[0])+C[25]*(DP[0]*(DP[2]-DP[8])+
 DP[6]*(DP[8]-DP[2])+DP[7]*DP[1])+C[23]*(DP[6]*DP[4]-DP[7]*DP[3]+DP[9]*
 DP[0])+C[20]*(-DP[4]*DP[0]-DP[9]*DP[6]))+C[2]*(DP[5]*(DP[0]*(DP[14]-
 DP[11])+DP[6]*(DP[11]-DP[14])-DP[10]*DP[7])+DP[13]*(DP[0]*(DP[2]-DP[8])+
 DP[6]*(DP[8]-DP[2])+DP[7]*DP[1])))+DP[12]*(DP[0]*(C[32]*DP[2]+C[17]*DP[4]+
 C[29]*DP[8]-C[24]*DP[9])+DP[6]*(C[29]*DP[2]-C[24]*DP[4]-C[26]*DP[8]+C[21]*
 DP[9])+DP[7]*(C[24]*DP[3]-C[29]*DP[1]))+C[10]*(DP[5]*(DP[10]*DP[7]-DP[11]*
 DP[6]-DP[14]*DP[0])+DP[13]*(DP[6]*DP[2]-DP[7]*DP[1]+DP[8]*DP[0]))+DP[0]*(
 C[17]*(DP[13]*DP[2]-DP[11]*DP[5]))+DP[6]*(C[3]*(DP[14]*DP[5]-DP[13]*
 DP[8])));
tmp[1]=+V[50]*(V[50]*(DP[5]*(C[2]*(DP[0]*(DP[12]*(DP[8]-DP[2]-DP[4]+DP[9])+
 ...
 DP[5]))+C[13]*(DP[11]*DP[6]-DP[10]*DP[7]+DP[14]*DP[0])+C[6]*(-DP[11]*DP[0]-
 DP[14]*DP[6]))+DP[12]*(DP[0]*(C[27]*DP[2]+C[4]*DP[4]-C[30]*DP[8]-C[11]*
 DP[9])+DP[6]*(C[27]*DP[8]-C[30]*DP[2]-C[11]*DP[4]+C[4]*DP[9])+DP[7]*(C[30]*
 DP[1]+C[11]*DP[3]))+DP[13]*(C[11]*(DP[7]*DP[1]-DP[6]*DP[2]-DP[8]*DP[0])+
 C[4]*(DP[2]*DP[0]+DP[8]*DP[6]))+tmp[0])+DP[5]*(C[10]*(DP[12]*(DP[0]*(-
 DP[8]-DP[9])+DP[6]*(-DP[2]-DP[4])+DP[7]*(DP[1]+DP[3]))+DP[13]*(DP[0]*(-
 DP[8]-DP[9])+DP[6]*(-DP[2]-DP[4])+DP[7]*(DP[1]+DP[3]))+DP[5]*(DP[11]*DP[6]-
 DP[10]*DP[7]+DP[14]*DP[0]))+DP[0]*(C[17]*(DP[2]*(-DP[12]-DP[13])+DP[4]*(-
 DP[12]-DP[13])+DP[11]*DP[5])+C[33]*DP[11]-C[14]*DP[14])+DP[6]*(C[3]*(DP[8]*
 (DP[12]+DP[13])+DP[9]*(DP[12]+DP[13])-DP[14]*DP[5])+C[7]*DP[14]-C[14]*
 DP[11])+C[14]*DP[10]*DP[7])+DP[12]*(DP[6]*(C[5]*(DP[2]-DP[9])+C[12]*DP[4]-
 C[28]*DP[8])+DP[0]*(C[5]*DP[8]+C[12]*DP[9])+DP[7]*(-C[5]*DP[1]-C[12]*
 DP[3]))+DP[13]*(C[12]*(DP[6]*DP[2]-DP[7]*DP[1]+DP[8]*DP[0])-C[5]*DP[8]*
 DP[6]));
R=+DP[7]*(V[50]*(DP[5]*(C[11]*(DP[12]*(DP[0]*(DP[8]+DP[9])+DP[6]*(DP[2]+
 ...
 C[15]*(DP[10]*DP[7]-DP[11]*DP[6]-DP[14]*DP[0])+C[8]*(DP[11]*DP[0]+DP[14]*
 DP[6]))+tmp[1])+DP[5]*(C[12]*(DP[12]*(DP[0]*(-DP[8]-DP[9])+DP[6]*(-DP[2]-
 DP[4])+DP[7]*(DP[1]+DP[3]))+DP[13]*(DP[0]*(-DP[8]-DP[9])+DP[6]*(-DP[2]-
 DP[4])+DP[7]*(DP[1]+DP[3]))+DP[5]*(DP[11]*DP[6]-DP[10]*DP[7]+DP[14]*
 DP[0]))+DP[6]*(C[5]*(DP[8]*(DP[12]+DP[13])+DP[9]*(DP[12]+DP[13])-DP[14]*
 DP[5])+C[16]*DP[11]-C[9]*DP[14])+C[16]*(DP[14]*DP[0]-DP[10]*DP[7])));
