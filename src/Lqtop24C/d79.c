...
#include"num_in.h"
#include"num_out.h"
extern FNN F410_out,F411_out,F412_out,F413_out,F414_out,F415_out,F416_out;
static FNN *Farr[7]={&F410_out,&F411_out,&F412_out,&F413_out,&F414_out
 ,&F415_out,&F416_out};
extern DNN S79_out;
REAL S79_out(double GG, REAL * momenta,int * err)
{REAL  ans=0;
REAL DP[15];
REAL* V=va_out;
REAL mass[6],width[6];
