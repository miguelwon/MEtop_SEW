...
#include"num_in.h"
#include"num_out.h"
extern FNN F817_out,F818_out,F819_out,F820_out,F821_out,F822_out;
static FNN *Farr[6]={&F817_out,&F818_out,&F819_out,&F820_out,&F821_out
 ,&F822_out};
extern DNN S213_out;
REAL S213_out(double GG, REAL * momenta,int * err)
{REAL  ans=0;
REAL DP[15];
REAL* V=va_out;
REAL mass[6],width[6];
