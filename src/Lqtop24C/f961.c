...
S[2]=V[33]*V[33];
S[3]=V[9]*V[9]*V[9]*V[9];
C[39]=+S[3]*(S[0]*(V[32]*(S[1]*(2*V[33]+V[32])+S[0]*(2*V[32]-4*V[33]))+S[2]*
 (2*S[0]+S[1])));
C[38]=+S[3]*(S[1]*(S[0]*(V[32]*(4*V[33]+2*V[32])+2*S[2])));
C[37]=+S[3]*(S[1]*(V[32]*(2*V[33]+V[32])+S[2]));
S[4]=V[9]*V[9];
C[36]=+S[4]*(S[0]*(V[32]*(S[1]*(8*V[33]+4*V[32])+S[0]*(8*V[32]-16*V[33]))+
 S[2]*(8*S[0]+4*S[1])));
C[35]=+S[4]*(S[1]*(S[0]*(V[32]*(16*V[33]+8*V[32])+8*S[2])));
C[34]=+S[4]*(S[1]*(V[32]*(8*V[33]+4*V[32])+4*S[2]));
C[33]=+S[0]*(V[32]*(S[1]*(8*V[33]+4*V[32])+S[0]*(8*V[32]-16*V[33]))+S[2]*(8*
 S[0]+4*S[1]));
C[32]=+S[1]*(S[0]*(V[32]*(16*V[33]+8*V[32])+8*S[2]));
C[31]=+S[1]*(V[32]*(8*V[33]+4*V[32])+4*S[2]);
S[5]=V[14]*V[14]*V[14]*V[14];
C[30]=+S[5]*(S[4]*(V[32]*(S[1]*(-8*V[33]-4*V[32])+S[0]*(8*V[32]-16*V[33]))+
 S[2]*(8*S[0]-4*S[1])));
C[29]=+S[4]*(S[0]*(V[32]*(S[1]*(-8*V[33]-4*V[32])+S[0]*(16*V[32]-32*V[33]))+
 S[2]*(16*S[0]-4*S[1])));
C[28]=+S[5]*(S[4]*(V[32]*(24*V[32]-48*V[33])+24*S[2]));
C[27]=+S[4]*(S[0]*(V[32]*(32*V[32]-64*V[33])+32*S[2]));
C[26]=+S[4]*(V[32]*(8*V[32]-16*V[33])+8*S[2]);
C[25]=+S[5]*(V[32]*(S[1]*(-8*V[33]-4*V[32])+S[0]*(8*V[32]-16*V[33]))+S[2]*(
 8*S[0]-4*S[1]));
C[24]=+S[0]*(V[32]*(S[1]*(-8*V[33]-4*V[32])+S[0]*(16*V[32]-32*V[33]))+S[2]*(
 16*S[0]-4*S[1]));
C[23]=+S[0]*(V[32]*(8*V[32]-16*V[33])+8*S[2]);
C[22]=+S[5]*(V[32]*(24*V[32]-48*V[33])+24*S[2]);
C[21]=+S[0]*(V[32]*(32*V[32]-64*V[33])+32*S[2]);
C[20]=+S[0]*(V[32]*(16*V[32]-32*V[33])+16*S[2]);
C[19]=+V[32]*(8*V[32]-16*V[33])+8*S[2];
C[18]=+S[4]*(S[0]*(V[32]*(S[1]*(4*V[33]+2*V[32])+S[0]*(4*V[32]-8*V[33]))+
 S[2]*(4*S[0]+2*S[1])));
C[17]=+S[4]*(S[1]*(S[0]*(V[32]*(8*V[33]+4*V[32])+4*S[2])));
C[16]=+S[4]*(S[1]*(V[32]*(4*V[33]+2*V[32])+2*S[2]));
C[15]=+S[3]*(S[5]*(V[32]*(S[1]*(-2*V[33]-V[32])+S[0]*(2*V[32]-4*V[33]))+
 S[2]*(2*S[0]-S[1])));
C[14]=+S[3]*(S[0]*(V[32]*(S[1]*(-2*V[33]-V[32])+S[0]*(4*V[32]-8*V[33]))+
 S[2]*(4*S[0]-S[1])));
C[13]=+S[3]*(S[0]*(V[32]*(2*V[32]-4*V[33])+2*S[2]));
C[12]=+S[5]*(S[4]*(V[32]*(S[1]*(-4*V[33]-2*V[32])+S[0]*(4*V[32]-8*V[33]))+
 S[2]*(4*S[0]-2*S[1])));
C[11]=+S[4]*(S[0]*(V[32]*(S[1]*(-4*V[33]-2*V[32])+S[0]*(8*V[32]-16*V[33]))+
 S[2]*(8*S[0]-2*S[1])));
C[10]=+S[4]*(S[0]*(V[32]*(4*V[32]-8*V[33])+4*S[2]));
C[9]=+S[3]*(S[5]*(V[32]*(6*V[32]-12*V[33])+6*S[2]));
C[8]=+S[3]*(S[0]*(V[32]*(8*V[32]-16*V[33])+8*S[2]));
C[7]=+S[5]*(S[4]*(V[32]*(12*V[32]-24*V[33])+12*S[2]));
C[6]=+S[4]*(S[0]*(V[32]*(16*V[32]-32*V[33])+16*S[2]));
C[5]=+S[3]*(S[0]*(V[32]*(4*V[32]-8*V[33])+4*S[2]));
C[4]=+S[3]*(V[32]*(2*V[32]-4*V[33])+2*S[2]);
C[3]=+S[4]*(S[0]*(V[32]*(8*V[32]-16*V[33])+8*S[2]));
...
REAL F961_out(double GG,REAL*DP,REAL*Q0,REAL*Q1,REAL*Q2)
{
/*
   B                       N2     !  N2                      B       
 ==<==\                 /==<======!==<==\                 /==<==     
