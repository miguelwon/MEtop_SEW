...
#include"num_in.h"
#include"num_out.h"
extern FNN F84_out,F85_out,F86_out,F87_out,F88_out,F89_out,F90_out;
static FNN *Farr[7]={&F84_out,&F85_out,&F86_out,&F87_out,&F88_out,&F89_out
 ,&F90_out};
extern DNN S14_out;
REAL S14_out(double GG, REAL * momenta,int * err)
{REAL  ans=0;
REAL DP[15];
REAL* V=va_out;
REAL mass[6],width[6];
