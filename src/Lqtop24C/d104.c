...
#include"num_in.h"
#include"num_out.h"
extern FNN F490_out,F491_out,F492_out,F493_out,F494_out,F495_out,F496_out;
static FNN *Farr[7]={&F490_out,&F491_out,&F492_out,&F493_out,&F494_out
 ,&F495_out,&F496_out};
extern DNN S104_out;
REAL S104_out(double GG, REAL * momenta,int * err)
{REAL  ans=0;
REAL DP[15];
REAL* V=va_out;
REAL mass[6],width[6];
