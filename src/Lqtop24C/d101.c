...
#include"num_in.h"
#include"num_out.h"
extern FNN F482_out,F483_out,F484_out,F485_out,F486_out,F487_out;
static FNN *Farr[6]={&F482_out,&F483_out,&F484_out,&F485_out,&F486_out
 ,&F487_out};
extern DNN S101_out;
REAL S101_out(double GG, REAL * momenta,int * err)
{REAL  ans=0;
REAL DP[15];
REAL* V=va_out;
REAL mass[6],width[6];
