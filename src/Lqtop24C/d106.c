...
#include"num_in.h"
#include"num_out.h"
extern FNN F498_out,F499_out,F500_out,F501_out,F502_out,F503_out,F504_out;
static FNN *Farr[7]={&F498_out,&F499_out,&F500_out,&F501_out,&F502_out
 ,&F503_out,&F504_out};
extern DNN S106_out;
REAL S106_out(double GG, REAL * momenta,int * err)
{REAL  ans=0;
REAL DP[15];
REAL* V=va_out;
REAL mass[6],width[6];
