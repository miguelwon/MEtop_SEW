...
S[0]=V[16]*V[16];
S[1]=V[7]*V[7]*V[7]*V[7];
C[18]=+S[1]*(V[15]*(4*V[15]-8*V[16])+4*S[0]);
S[2]=V[9]*V[9];
C[17]=+S[1]*(S[2]*(V[15]*(2*V[16]+V[15])+S[0]));
C[16]=+S[1]*(V[15]*(8*V[15]-16*V[16])+8*S[0]);
C[15]=+S[1]*(S[2]*(V[15]*(4*V[16]+2*V[15])+2*S[0]));
C[14]=+S[1]*(V[15]*(2*V[15]-4*V[16])+2*S[0]);
S[3]=V[7]*V[7];
C[13]=+S[3]*(V[15]*(32*V[15]-64*V[16])+32*S[0]);
C[12]=+S[3]*(S[2]*(V[15]*(16*V[16]+8*V[15])+8*S[0]));
C[11]=+V[15]*(16*V[15]-32*V[16])+16*S[0];
C[10]=+S[2]*(V[15]*(8*V[16]+4*V[15])+4*S[0]);
C[9]=+V[15]*(32*V[15]-64*V[16])+32*S[0];
C[8]=+S[2]*(V[15]*(16*V[16]+8*V[15])+8*S[0]);
...
C[3]=+S[3]*(S[2]*(V[15]*(8*V[16]+4*V[15])+4*S[0]));
