...
static int genlqtop(char fevtemp[],int Nsubpro,int NEvnts,int SpCorr,int Flav1,int Flav2,int Flav3,
int Flav4,int Flav5,int Flav6,double m1,double m2,double m3,double m4,double m5,double m6,int pp)
{
int i,j,k,l,count,Ncubes,NEvntstemp,maxloop,ic,ipmax,ipmin,Flav2temp;
int MCcode1,MCcode2,MCcode3,MCcode4,MCcode5,MCcode6,subpro[6],NprSub,qid,SubPorder,err,cb_chain1[6],cb_chain2[10];
